...
export default function TopicModal({ collections, pack, preferredCollectionId, onClose, onChanged }: Props) {
  ...
  async function archive() {
    if (!pack || !window.confirm(`Archive ${pack.title}?`)) return;
    setBusy(true); setMessage("");
