...
type Props = { collections: Collection[]; packs: PackWithType[]; onClose: () => void; onChanged: () => Promise<void> | void };
const ACCENTS: AccentKey[] = ["cinnabar", "indigo", "amber", "sage", "burgundy", "slate", "ink"];

export default function CollectionsModal({ collections, packs, onClose, onChanged }: Props) {
